...
from picard.file import (
    run_file_post_addition_to_album_processors,
    run_file_post_removal_from_album_processors,
)
...
class Track(DataObject, Item):
    ...
    def add_file(self, file):
        ...
        run_file_post_addition_to_album_processors(self, file)
    ...
    def remove_file(self, file):
        ...
        run_file_post_removal_from_album_processors(self, file)
        self.update()
