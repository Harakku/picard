...
_file_post_addition_to_album_processors = PluginFunctions(label='file_post_addition_to_album_processors')
_file_post_removal_from_album_processors = PluginFunctions(label='file_post_removal_from_album_processors')


def register_file_post_addition_to_album_processor(function, priority=PluginPriority.NORMAL):
    """Registers a file-added-to-album processor.
    Args:
    ...
    Returns:
        None
    """
    _file_post_addition_to_album_processors.register(function.__module__, function, priority)


def register_file_post_removal_from_album_processor(function, priority=PluginPriority.NORMAL):
    """Registers a file-removed-from-album processor.
    Args:
    ...
    Returns:
        None
    """
    _file_post_removal_from_album_processors.register(function.__module__, function, priority)


def run_file_post_addition_to_album_processors(track_object, file_object):
    _file_post_addition_to_album_processors.run(track_object, file_object)


def run_file_post_removal_from_album_processors(track_object, file_object):
    _file_post_removal_from_album_processors.run(track_object, file_object)
